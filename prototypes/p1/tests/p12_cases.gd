...
static func clue_navigation_routes(t: SceneTree, app: Main, longest_row: int, longest_column: int) -> void:
	...
	var cell_point: Vector2 = b.get_global_transform() * b.view.cell_rect(Vector2i(50, 50)).get_center()
