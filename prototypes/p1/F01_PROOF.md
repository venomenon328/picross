...
F-01, ursprünglich Revision 1, ist ein eigens für #8 am 22.09.2026 aus Rasterkoordinaten
...
Abschlussrepräsentation in Revision 2 ist ein eigenes 800×800-SVG: gleiche beiden
Segelflächen, Mast und breiter Rumpf, ergänzt um Nähte, Takelage, Planken, Bullaugen
und Wasserlinien. Keine fremde Vorlage. P1 0.4/D-10 löst die frühere Pflicht zur
identischen Pixelmaske ab. Die logische Lösung und alle Hinweise bleiben unverändert;
Motivtreue wird durch gerenderten Vergleich geprüft, nicht vom Datenvalidator behauptet.

## Daten

[data/f01.json](data/f01.json) enthält Schema 2, stabile ID/Revision, Dimensionen,
...
[data/f01-proof.json](data/f01-proof.json) dokumentiert 48 logisch unveränderte aufeinanderfolgende
Linienschlüsse. Zeilen/Spalten und Zellpositionen im Zertifikat sind einsbasiert.
Nur der Zertifikat-Revisionsbezug wurde von 1 auf 2 aktualisiert.
...
abgelehnt. Die Routine ist auf F-01 Revision 2/20×20 monochrom begrenzt, bleibt
